...
public class CashAdapter extends BaseAdapter
{
    ...
    public CashAdapter(Context context , ArrayList<RateBean> list)
    {
    ...
    public View getView(int position , View convertView , ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            convertView=inflater.inflate(R.layout.activity_cash_adapter, null);
            holder = new ViewHolder
                    (
                            (TextView)convertView.findViewById(R.id.xml_currency),
                            (TextView)convertView.findViewById(R.id.xml_buy_in),
                            (TextView)convertView.findViewById(R.id.xml_sold_out)
                    );
